...
impl Udh {
    ...
    pub fn push_element(&mut self, element: UdhElement) {
...
mod tests {
    ...
    mod encode {
        ...
        mod borrowed {
            ...
            fn ok() {
                ...
                let udh = UdhElement::new(UdhValue::ConcatenatedShortMessage16Bit(
                    ConcatenatedShortMessage16Bit::new(0x1234, 3, 1).unwrap(),
                ));
                ...
                let udh = UdhElement::new(UdhValue::ConcatenatedShortMessage8Bit(
                    ConcatenatedShortMessage8Bit::new(0x12, 3, 1).unwrap(),
                ));
                let expected = [
    ...
    mod decode {
        ...
        use crate::{decode::owned::Decode, encode::owned::Encode};

        use super::*;

        // TODO: remove this thing and impl other tests
        #[test]
        fn hmm() {
            let mut buf =
            ...
            let udh = Udh::new(vec![
                UdhElement::new(UdhValue::ConcatenatedShortMessage8Bit(
                    ConcatenatedShortMessage8Bit::new(74, 3, 1).unwrap(),
                )),
                UdhElement::new(UdhValue::Other {
                    udh_id: UdhId::NationalLanguageLockingShift,
                    value: AnyOctetString::from(vec![1]),
                }),
            ]);
            ...
            assert_eq!(
                &encoded[..],
                &[0x08, 0x00, 0x03, 0x4A, 0x03, 0x01, 0x25, 0x01, 0x01][..]
            );
        }
        ...
        fn ok() {
            ...
            assert_eq!(
                udh,
                UdhElement::new(UdhValue::ConcatenatedShortMessage16Bit(
                    ConcatenatedShortMessage16Bit::new(0x1234, 3, 1).unwrap()
                ))
            );
