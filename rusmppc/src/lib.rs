//! # Rusmppc
//!
//! A Rust [SMPP v5](https://smpp.org/SMPP_v5.pdf) client.
//!
//! ## Features
//!
//! - `tokio`: Enabled support for [`tokio`](https://docs.rs/tokio/latest/tokio/) runtime. Enabled by default.
//! - `wasm`: Enabled support for [`wasm`].
