...
use crate::{
    Client,
    event_::{DefaultEventChannel, DiscardEventChannel, EventChannel, InsightEventChannel},
...
impl<E: EventChannel, D: Delay, T: Timeout, R> ConnectionBuilder<E, D, T, R> {
    ...
    {
        crate::managed_::UnboundManagedConnectionBuilder::new(self)
    }
}
